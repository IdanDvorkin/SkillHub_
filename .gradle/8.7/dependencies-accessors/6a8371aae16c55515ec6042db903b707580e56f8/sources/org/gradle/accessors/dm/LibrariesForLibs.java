...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Group of libraries at <b>firebaseui</b>
     */
    public FirebaseuiLibraryAccessors getFirebaseui() {
    ...
    public static class FirebaseuiLibraryAccessors extends SubDependencyFactory {
        private final FirebaseuiFirebaseLibraryAccessors laccForFirebaseuiFirebaseLibraryAccessors = new FirebaseuiFirebaseLibraryAccessors(owner);

        public FirebaseuiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>firebaseui.firebase</b>
         */
        public FirebaseuiFirebaseLibraryAccessors getFirebase() {
            return laccForFirebaseuiFirebaseLibraryAccessors;
        }

    }

    public static class FirebaseuiFirebaseLibraryAccessors extends SubDependencyFactory {
        private final FirebaseuiFirebaseUiLibraryAccessors laccForFirebaseuiFirebaseUiLibraryAccessors = new FirebaseuiFirebaseUiLibraryAccessors(owner);

        public FirebaseuiFirebaseLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>firebaseui.firebase.ui</b>
         */
        public FirebaseuiFirebaseUiLibraryAccessors getUi() {
            return laccForFirebaseuiFirebaseUiLibraryAccessors;
        }

    }

    public static class FirebaseuiFirebaseUiLibraryAccessors extends SubDependencyFactory {

        public FirebaseuiFirebaseUiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>auth</b> with <b>com.firebaseui:firebase-ui-auth</b> coordinates and
         * with version reference <b>firebaseUiAuthVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAuth() {
            return create("firebaseui.firebase.ui.auth");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebaseUiAuthVersion</b> with value <b>8.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFirebaseUiAuthVersion() { return getVersion("firebaseUiAuthVersion"); }
